...
type CalculatorServiceClient interface {
	Sum(ctx context.Context, in *CalculatorSumRequest, opts ...grpc.CallOption) (*CalculatorSumResponse, error)
	Primes(ctx context.Context, in *CalculatorPrimesRequest, opts ...grpc.CallOption) (CalculatorService_PrimesClient, error)
	...
	Sqrt(ctx context.Context, in *CalculatorSqrtRequest, opts ...grpc.CallOption) (*CalculatorSqrtResponse, error)
}
...
func (c *calculatorServiceClient) Sum(ctx context.Context, in *CalculatorSumRequest, opts ...grpc.CallOption) (*CalculatorSumResponse, error) {
	out := new(CalculatorSumResponse)
...
func (c *calculatorServiceClient) Primes(ctx context.Context, in *CalculatorPrimesRequest, opts ...grpc.CallOption) (CalculatorService_PrimesClient, error) {
...
type CalculatorService_PrimesClient interface {
	Recv() (*CalculatorPrimesResponse, error)
	grpc.ClientStream
}
...
func (x *calculatorServicePrimesClient) Recv() (*CalculatorPrimesResponse, error) {
	m := new(CalculatorPrimesResponse)
...
type CalculatorService_AverageClient interface {
	Send(*CalculatorAvgRequest) error
...
func (x *calculatorServiceAverageClient) Send(m *CalculatorAvgRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceAverageClient) CloseAndRecv() (*CalculatorAvgResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type CalculatorService_MaxClient interface {
	Send(*CalculatorMaxRequest) error
	Recv() (*CalculatorMaxResponse, error)
	grpc.ClientStream
}
...
func (x *calculatorServiceMaxClient) Send(m *CalculatorMaxRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceMaxClient) Recv() (*CalculatorMaxResponse, error) {
	m := new(CalculatorMaxResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *calculatorServiceClient) Sqrt(ctx context.Context, in *CalculatorSqrtRequest, opts ...grpc.CallOption) (*CalculatorSqrtResponse, error) {
	out := new(CalculatorSqrtResponse)
...
type CalculatorServiceServer interface {
	Sum(context.Context, *CalculatorSumRequest) (*CalculatorSumResponse, error)
	Primes(*CalculatorPrimesRequest, CalculatorService_PrimesServer) error
	Average(CalculatorService_AverageServer) error
	Max(CalculatorService_MaxServer) error
	Sqrt(context.Context, *CalculatorSqrtRequest) (*CalculatorSqrtResponse, error)
...
func (UnimplementedCalculatorServiceServer) Sum(context.Context, *CalculatorSumRequest) (*CalculatorSumResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sum not implemented")
}
func (UnimplementedCalculatorServiceServer) Primes(*CalculatorPrimesRequest, CalculatorService_PrimesServer) error {
...
func (UnimplementedCalculatorServiceServer) Sqrt(context.Context, *CalculatorSqrtRequest) (*CalculatorSqrtResponse, error) {
...
func _CalculatorService_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).Sum(ctx, req.(*CalculatorSumRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CalculatorService_Primes_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(CalculatorPrimesRequest)
...
type CalculatorService_PrimesServer interface {
	Send(*CalculatorPrimesResponse) error
	grpc.ServerStream
}
...
func (x *calculatorServicePrimesServer) Send(m *CalculatorPrimesResponse) error {
...
type CalculatorService_AverageServer interface {
	...
	Recv() (*CalculatorAvgRequest, error)
	grpc.ServerStream
}
...
func (x *calculatorServiceAverageServer) SendAndClose(m *CalculatorAvgResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceAverageServer) Recv() (*CalculatorAvgRequest, error) {
	m := new(CalculatorAvgRequest)
...
type CalculatorService_MaxServer interface {
	Send(*CalculatorMaxResponse) error
	Recv() (*CalculatorMaxRequest, error)
	grpc.ServerStream
}
...
func (x *calculatorServiceMaxServer) Send(m *CalculatorMaxResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceMaxServer) Recv() (*CalculatorMaxRequest, error) {
	m := new(CalculatorMaxRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _CalculatorService_Sqrt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).Sqrt(ctx, req.(*CalculatorSqrtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
