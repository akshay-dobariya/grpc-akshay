...
type CalculatorPrimesRequest struct {
...
func (x *CalculatorPrimesRequest) Reset() {
	*x = CalculatorPrimesRequest{}
...
func (x *CalculatorPrimesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorPrimesRequest) ProtoMessage() {}

func (x *CalculatorPrimesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_primes_proto_msgTypes[0]
...
// Deprecated: Use CalculatorPrimesRequest.ProtoReflect.Descriptor instead.
func (*CalculatorPrimesRequest) Descriptor() ([]byte, []int) {
	return file_primes_proto_rawDescGZIP(), []int{0}
}

func (x *CalculatorPrimesRequest) GetNum() uint64 {
	if x != nil {
		return x.Num
	}
	return 0
...
type CalculatorPrimesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CalculatorPrimesResponse) Reset() {
	*x = CalculatorPrimesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalculatorPrimesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorPrimesResponse) ProtoMessage() {}

func (x *CalculatorPrimesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_primes_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalculatorPrimesResponse.ProtoReflect.Descriptor instead.
func (*CalculatorPrimesResponse) Descriptor() ([]byte, []int) {
	return file_primes_proto_rawDescGZIP(), []int{1}
}

func (x *CalculatorPrimesResponse) GetResult() uint64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_primes_proto_rawDesc = []byte{
	...
	,
...
var file_primes_proto_goTypes = []interface{}{
	(*CalculatorPrimesRequest)(nil),  // 0: calculator.CalculatorPrimesRequest
	(*CalculatorPrimesResponse)(nil), // 1: calculator.CalculatorPrimesResponse
}
...
func file_primes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_primes_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalculatorPrimesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_primes_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalculatorPrimesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
