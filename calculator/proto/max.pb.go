...
type CalculatorMaxRequest struct {
...
func (x *CalculatorMaxRequest) Reset() {
	*x = CalculatorMaxRequest{}
...
func (x *CalculatorMaxRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorMaxRequest) ProtoMessage() {}

func (x *CalculatorMaxRequest) ProtoReflect() protoreflect.Message {
	mi := &file_max_proto_msgTypes[0]
...
// Deprecated: Use CalculatorMaxRequest.ProtoReflect.Descriptor instead.
func (*CalculatorMaxRequest) Descriptor() ([]byte, []int) {
	return file_max_proto_rawDescGZIP(), []int{0}
}

func (x *CalculatorMaxRequest) GetNum() int64 {
	if x != nil {
		return x.Num
	}
	return 0
...
type CalculatorMaxResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CalculatorMaxResponse) Reset() {
	*x = CalculatorMaxResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalculatorMaxResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorMaxResponse) ProtoMessage() {}

func (x *CalculatorMaxResponse) ProtoReflect() protoreflect.Message {
	mi := &file_max_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalculatorMaxResponse.ProtoReflect.Descriptor instead.
func (*CalculatorMaxResponse) Descriptor() ([]byte, []int) {
	return file_max_proto_rawDescGZIP(), []int{1}
}

func (x *CalculatorMaxResponse) GetResult() int64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_max_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x74, 0x6f, 0x72, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6e, 0x75,
	0x6d, 0x22, 0x2f, 0x0a, 0x15, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x4d,
...
var file_max_proto_goTypes = []interface{}{
	(*CalculatorMaxRequest)(nil),  // 0: calculator.CalculatorMaxRequest
	(*CalculatorMaxResponse)(nil), // 1: calculator.CalculatorMaxResponse
}
...
func file_max_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_max_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalculatorMaxRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_max_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalculatorMaxResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
